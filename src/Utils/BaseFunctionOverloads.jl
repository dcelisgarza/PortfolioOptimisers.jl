for (op, name) ∈
    zip((Solver, LinearConstraintSide, BlackLittermanViewsEstimator, LinearConstraint,
        ...
        ("Solver", "LinearConstraintSide", "BlackLittermanViewsEstimator",
         ...
         "FirstLowerPartialMoment", "NegativeQuadraticSemiSkewness", "NegativeSemiSkewness",
         ...
         "SkewnessEntropyPoolingView", "KurtosisEntropyPoolingView",
         "C2_LinearEntropyPoolingConstraint", "C4_LinearEntropyPoolingConstraint",
         "EntropyPoolingView", "EmpiricalPriorResult", "HighOrderPriorModel",
         "EqualRiskMeasure", "CentralityConstraint"))
    eval(quote
