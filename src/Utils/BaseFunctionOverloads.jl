for (op, name) ∈
    zip((Solver, LinearConstraint, PartialLinearConstraintAtom, LinearConstraintAtom,
         MeanReturn, Skewness, ThirdCentralMoment, FourthLowerPartialMoment, SemiKurtosis,
         SemiSkewness, ThirdLowerPartialMoment, FourthCentralMoment, Kurtosis,
         ValueatRiskRange, ValueatRisk, DrawdownatRisk, RelativeAverageDrawdown,
         ...
         OrderedWeightsArray, EntropyPoolingView, C0_EntropyPoolingView,
        ...
        ("Solver", "LinearConstraint", "PartialLinearConstraintAtom",
         ...
         "TurnoverRiskMeasure", "OrderedWeightsArray", "EntropyPoolingView",
         "C0_EntropyPoolingView", "C1_EntropyPoolingView", "C2_EntropyPoolingView",
