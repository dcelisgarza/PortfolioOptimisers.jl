...
[`denoise!`](@ref) in `src/04_MatrixProcessing/02_Denoise.jl` states the mathematics of the denoising step, and
[`posdef!`](@ref) in `src/04_MatrixProcessing/01_PosdefMatrix.jl` that of the projection.
