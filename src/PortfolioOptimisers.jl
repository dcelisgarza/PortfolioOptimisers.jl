...
include("./12_ConstraintGeneration/3_CardinalityConstraintGeneration.jl")
include("./12_ConstraintGeneration/4_WeightBoundsConstraintGeneration.jl")
include("./12_ConstraintGeneration/5_RiskBudgetConstraintGeneration.jl")
include("./12_ConstraintGeneration/6_PhilogenyConstraintGeneration.jl")
include("./12_ConstraintGeneration/1_NewLinearConstraints.jl")
...
include("./13_Prior/10_EntropyPoolingViewsGeneration.jl")
include("./13_Prior/11_EntropyPoolingPrior.jl")
include("./13_Prior/12_OpinionPoolingPrior.jl")
...
include("./18_RiskMeasures/21_NoOptimisationRiskMeasures.jl")
include("./18_RiskMeasures/22_AdjustRiskContributions.jl")
include("./18_RiskMeasures/23_ExpectedRisk.jl")
include("./18_RiskMeasures/24_RiskMeasureTools.jl")
...
include("./19_Optimisation/18_Base_AssetAllocation.jl")
include("./19_Optimisation/19_GreedyAssetAllocation.jl")
include("./19_Optimisation/20_DiscreteAssetAllocation.jl")
