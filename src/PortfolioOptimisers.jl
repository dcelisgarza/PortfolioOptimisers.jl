...
include("./Optimisation/Scalariser/Scalariser_AbstractTypes.jl")
include("./Optimisation/Scalariser/SumScalariser.jl")
include("./Optimisation/Scalariser/MaxScalariser.jl")
include("./Optimisation/Scalariser/LogSumExpScalariser.jl")
include("./Optimisation/ConstraintModel/ConstraintModel_AbstractTypes.jl")
include("./Optimisation/ConstraintModel/WeightConstraints.jl")
include("./Optimisation/ConstraintModel/BudgetConstraints.jl")
include("./Optimisation/ConstraintModel/LongShortBoundConstraints.jl")
