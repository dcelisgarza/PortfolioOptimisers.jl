...
"""
function is_time_dependent(opt::HierarchicalRiskParity)
    return is_time_dependent(opt.opt) || is_time_dependent(opt.fb)
end
function assert_time_dependent_fold_count(opt::HierarchicalRiskParity, n::Integer)::Nothing
...
"""
function update_time_dependent_estimator(opt::HierarchicalRiskParity,
