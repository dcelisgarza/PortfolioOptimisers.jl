...
const arg_dict = unique_key_dict(:arg_dict,
                                 ...
                                 :ep_tv_bracket => "`bracket`: Spans the searches of this estimator run over, as a named tuple. Left empty every span takes the value the search documents. A key the statistic does not name raises.",#
