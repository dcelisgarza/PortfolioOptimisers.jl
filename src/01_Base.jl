...
const arg_dict = unique_key_dict(:arg_dict,
                                 ...
                                 :rlvar_zpct => "`pct`: Fractional half-width of the grid of relativistic value-at-risk dual variables, centred on the value that attains the prior relativistic value-at-risk.",#
                                 :rlvar_zK => "`K`: Number of points of the grid of relativistic value-at-risk dual variables. Must be odd.",#
