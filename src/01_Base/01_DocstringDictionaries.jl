...
const arg_dict = unique_key_dict(:arg_dict,
                                 ...
                                 :expand_train => "`expand_train`: Whether to expand the training window over time. The constructor keyword takes `nothing`, which derives the field from the Fold Fit: `true` under an `OnlineStep`, because an online run is expanding by construction, and `false` otherwise. An explicit `false` beside an `OnlineStep` is refused.",#
                                 :ff => "`ff`: Fold Fit of the scheme, or `nothing` to refit every fold from its training window. An [`OnlineStep`](@ref) makes the fold loop warm up once on the first training window and then fold each fold's new observations into one estimator threaded from fold to fold, reading it out where a refit would have run.",#
...
const ref_dict = unique_key_dict(:ref_dict,
                                 ...
                                 :li2015olmar => "[li2015olmar](@cite) B. Li, S. C. H. Hoi, D. Sahoo and Z.-Y. Liu. *Moving average reversion strategy for on-line portfolio selection*. Artificial Intelligence 222, 104–123 (2015).",#
                                 :lai2018ppt => "[lai2018ppt](@cite) Z.-R. Lai, D.-Q. Dai, C.-X. Ren and K.-K. Huang. *A peak price tracking-based learning system for portfolio selection*. IEEE Transactions on Neural Networks and Learning Systems 29, 2823–2832 (2018).",#
                                 :lai2018sspo => "[lai2018sspo](@cite) Z.-R. Lai, P.-Y. Yang, L. Fang and X. Wu. *Short-term sparse portfolio optimization based on alternating direction method of multipliers*. Journal of Machine Learning Research 19, 1–28 (2018).",#
                                 :li2018tco => "[li2018tco](@cite) B. Li, J. Wang, D. Huang and S. C. H. Hoi. *Transaction cost optimization for online portfolio selection*. Quantitative Finance 18, 1411–1424 (2018).",#
                                 :moon2019 => "[moon2019](@cite) S.-H. Moon. *Empirical investigation of state-of-the-art mean reversion strategies for equity markets*. arXiv preprint arXiv:1909.04327 (2019).",#
                                 :lai2018rprt => "[lai2018rprt](@cite) Z.-R. Lai, P.-Y. Yang, L. Fang and X. Wu. *Reweighted price relative tracking system for automatic portfolio optimization*. IEEE Transactions on Systems, Man, and Cybernetics: Systems 50, 4349–4361 (2020).",#
                                 :liluoxu2023 => "[liluoxu2023](@cite) Y. Li, X. Luo and J. Xu. *Peak price ratio tracking system for online portfolio selection*. IEEE Access 11, 51398–51410 (2023).",#
                                 :lai2018aictr => "[lai2018aictr](@cite) Z.-R. Lai, D.-Q. Dai, C.-X. Ren and K.-K. Huang. *Radial basis functions with adaptive input and composite trend representation for portfolio selection*. IEEE Transactions on Neural Networks and Learning Systems 29, 6214–6226 (2018).",#
                                 :dai2022tppt => "[dai2022tppt](@cite) H.-L. Dai, Y.-Y. Liang, F.-T. Dai, C.-Y. Huang and M. Adnan. *A trend-promote price tracking system for online portfolio selection*. IEEE Transactions on Neural Networks and Learning Systems (2022).",#
                                 :lai2018ktpt => "[lai2018ktpt](@cite) Z.-R. Lai, P.-Y. Yang, X. Wu and L. Fang. *A kernel-based trend pattern tracking system for portfolio optimization*. Data Mining and Knowledge Discovery 32, 1708–1734 (2018).",#
                                 :zouhastie2005 => "[zouhastie2005](@cite) H. Zou and T. Hastie. *Regularization and variable selection via the elastic net*. Journal of the Royal Statistical Society: Series B (Statistical Methodology) 67, 301–320 (2005).",#
                                 :friedman2010 => "[friedman2010](@cite) J. Friedman, T. Hastie and R. Tibshirani. *Regularization paths for generalized linear models via coordinate descent*. Journal of Statistical Software 33, 1–22 (2010).",#
                                 :caiye2019 => "[caiye2019](@cite) X. Cai and Z. Ye. *Gaussian weighting reversion strategy for accurate online portfolio selection*. IEEE Transactions on Signal Processing 67, 5558–5570 (2019).",#
                                 :gaivoronski2000 => "[gaivoronski2000](@cite) A. A. Gaivoronski and F. Stella. *Stochastic nonstationary optimization for finding universal portfolios*. Annals of Operations Research 100, 165–188 (2000).",#
                                 :hazankale2012 => "[hazankale2012](@cite) E. Hazan and S. Kale. *An online portfolio selection algorithm with regret logarithmic in price variation*. Mathematical Finance 25, 288–310 (2015).",#
                                 :gyorfischafer2003 => "[gyorfischafer2003](@cite) L. Györfi and D. Schäfer. *Nonparametric prediction*. In: Advances in Learning Theory: Methods, Models and Applications, 339–354 (IOS Press, 2003).",#
                                 :gyorfi2006 => "[gyorfi2006](@cite) L. Györfi, G. Lugosi and F. Udina. *Nonparametric kernel-based sequential investment strategies*. Mathematical Finance 16, 337–357 (2006).",#
                                 :gyorfi2008 => "[gyorfi2008](@cite) L. Györfi, F. Udina and H. Walk. *Nonparametric nearest neighbor based empirical portfolio selection strategies*. Statistics & Decisions 26, 145–157 (2008).",#
                                 :gyorfi2007semilog => "[gyorfi2007semilog](@cite) L. Györfi, A. Urbán and I. Vajda. *Kernel-based semi-log-optimal empirical portfolio selection strategies*. International Journal of Theoretical and Applied Finance 10, 505–516 (2007).",#
                                 :ottucsakvajda2007 => "[ottucsakvajda2007](@cite) G. Ottucsák and I. Vajda. *An asymptotic analysis of the mean-variance portfolio selection*. Statistics & Decisions 25, 63–88 (2007).",#
                                 :gyorfivajda2008 => "[gyorfivajda2008](@cite) L. Györfi and I. Vajda. *Growth optimal investment with transaction costs*. In: Algorithmic Learning Theory, Lecture Notes in Computer Science 5254, 108–122 (Springer, 2008).",#
                                 :hazanseshadhri2009 => "[hazanseshadhri2009](@cite) E. Hazan and C. Seshadhri. *Efficient learning algorithms for changing environments*. In: Proceedings of the 26th International Conference on Machine Learning, 393–400 (2009).",#
                                 :xi2023oldem => "[xi2023oldem](@cite) W. Xi, Z. Li, X. Song and H. Ning. *Online portfolio selection with predictive instantaneous risk assessment*. Pattern Recognition 144, 109872 (2023).",#
                                 :lai2020spolc => "[lai2020spolc](@cite) Z.-R. Lai, L. Tan, X. Wu and L. Fang. *Loss control with rank-one covariance estimate for short-term portfolio optimization*. Journal of Machine Learning Research 21, 1–37 (2020).",#
                                 :khedmatiazin2020 => "[khedmatiazin2020](@cite) M. Khedmati and P. Azin. *An online portfolio selection algorithm using clustering approaches and considering transaction costs*. Expert Systems with Applications 159, 113546 (2020).",#
                                 :wang2018racorn => "[wang2018racorn](@cite) Y. Wang, D. Wang, Y. Wang and Y. Zhang. *RACORN-K: Risk-aversion pattern matching-based portfolio selection*. arXiv:1802.10244 (2018).",#
                                 :guanan2019 => "[guanan2019](@cite) H. Guan and Z. An. *A local adaptive learning system for online portfolio selection*. Knowledge-Based Systems 186, 104958 (2019).",#
                                 ...
                                 :li2011cwmr => "[li2011cwmr](@cite) B. Li, S. C. H. Hoi, P. Zhao and V. Gopalkrishnan. *Confidence weighted mean reversion strategy for on-line portfolio selection*. In: Proceedings of the 14th International Conference on Artificial Intelligence and Statistics, PMLR 15, 434–442 (2011).",#
                                 ...
                                 :kalnishkanvyugin2008 => "[kalnishkanvyugin2008](@cite) Y. Kalnishkan and M. V. Vyugin. *The weak aggregating algorithm and weak mixability*. Journal of Computer and System Sciences 74(8), 1228–1244 (2008).",#
                                 :yang2020waeg => "[yang2020waeg](@cite) X. Yang, J. He, H. Lin and Y. Zhang. *Boosting exponential gradient strategy for online portfolio selection: An aggregating experts' advice method*. Computational Economics 55(1), 231–251 (2020).",#
                                 :yang2022caeg => "[yang2022caeg](@cite) X. Yang, J. He and Y. Zhang. *Aggregating exponential gradient expert advice for online portfolio selection*. Journal of the Operational Research Society 73(3), 587–597 (2022).",#
                                 :zinkevich2003 => "[zinkevich2003](@cite) M. Zinkevich. *Online convex programming and generalized infinitesimal gradient ascent*. In: Proceedings of the 20th International Conference on Machine Learning, 928–936 (2003).",#
                                 :abernethy2015 => "[abernethy2015](@cite) J. D. Abernethy, C. Lee and A. Tewari. *Fighting bandits with a new kind of smoothness*. In: Advances in Neural Information Processing Systems 28 (2015).",#
                                 :zimmertseldin2021 => "[zimmertseldin2021](@cite) J. Zimmert and Y. Seldin. *Tsallis-INF: An optimal algorithm for stochastic and adversarial bandits*. Journal of Machine Learning Research 22(28), 1–49 (2021).",#
                                 :li2022egm => "[li2022egm](@cite) Y. Li, X. Zheng, C. Chen, J. Wang and S. Xu. *Exponential gradient with momentum for online portfolio selection*. Expert Systems with Applications 187, 115889 (2022).",#
                                 :zhang2022maeg => "[zhang2022maeg](@cite) Y. Zhang, H. Lin, L. Zheng and X. Yang. *Adaptive online portfolio strategy based on exponential gradient updates*. Journal of Combinatorial Optimization 43(3), 672–696 (2022).",#
                                 :duchi2011 => "[duchi2011](@cite) J. Duchi, E. Hazan and Y. Singer. *Adaptive subgradient methods for online learning and stochastic optimization*. Journal of Machine Learning Research 12, 2121–2159 (2011).",#
                                 :rakhlin2013colt => "[rakhlin2013colt](@cite) A. Rakhlin and K. Sridharan. *Online learning with predictable sequences*. In: Proceedings of the 26th Annual Conference on Learning Theory, 993–1019 (2013).",#
                                 :rakhlin2013nips => "[rakhlin2013nips](@cite) A. Rakhlin and K. Sridharan. *Optimization, learning, and games with predictable sequences*. In: Advances in Neural Information Processing Systems 26, 3066–3074 (2013).",#
                                 :chiang2012 => "[chiang2012](@cite) C.-K. Chiang, T. Yang, C.-J. Lee, M. Mahdavi, C.-J. Lu, R. Jin and S. Zhu. *Online optimization with gradual variations*. In: Proceedings of the 25th Annual Conference on Learning Theory, 6.1–6.20 (2012).",#
