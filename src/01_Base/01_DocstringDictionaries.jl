...
const ref_dict = unique_key_dict(:ref_dict,
                                 ...
                                 :liluoxu2023 => "[liluoxu2023](@cite) B. Li, J. Luo and H. Xu. *A portfolio selection strategy based on the peak price involving randomness*. IEEE Access 11, 52066–52074 (2023).",#
                                 ...
                                 :dai2022tppt => "[dai2022tppt](@cite) H.-L. Dai, C.-X. Liang, H.-M. Dai, C.-Y. Huang and R. M. Adnan. *An online portfolio strategy based on trend promote price tracing ensemble learning algorithm*. Knowledge-Based Systems 239, 107957 (2022).",#
                                 ...
                                 :jump2026cones => "[jump2026cones](@cite) The JuMP Developers. *Modeling with cones*, a conic programming tutorial of the JuMP documentation (2026).",#
