struct SmythBrobyGerber2Covariance{T1 <: ExpectedReturnsEstimator,
...
function SmythBrobyGerber2Covariance(;
    ...
    return SmythBrobyGerber2Covariance{typeof(me), typeof(ve), typeof(fnpdm),
                                       typeof(threshold), typeof(c1), typeof(c2),
                                       typeof(c3), typeof(n)}(me, ve, fnpdm, threshold, c1,
                                                              c2, c3, n)
end
function moment_factory_w(ce::SmythBrobyGerber2Covariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBrobyGerber2Covariance(; me = moment_factory_w(ce.me, w),
