struct SmythBroby1Covariance{T1 <: ExpectedReturnsEstimator,
...
function SmythBroby1Covariance(; me::ExpectedReturnsEstimator = SimpleExpectedReturns(),
    ...
    return SmythBroby1Covariance{typeof(me), typeof(ve), typeof(fnpdm), typeof(threshold),
...
function moment_factory_w(ce::SmythBroby1Covariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBroby1Covariance(; me = moment_factory_w(ce.me, w),
