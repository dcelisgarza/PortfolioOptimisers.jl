struct SmythBroby0NormalisedCovariance{T1 <: ExpectedReturnsEstimator,
...
function SmythBroby0NormalisedCovariance(;
    ...
    return SmythBroby0NormalisedCovariance{typeof(me), typeof(ve), typeof(fnpdm),
                                           typeof(threshold), typeof(c1), typeof(c2),
                                           typeof(c3), typeof(n)}(me, ve, fnpdm, threshold,
                                                                  c1, c2, c3, n)
end
function moment_factory_w(ce::SmythBroby0NormalisedCovariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBroby0NormalisedCovariance(; me = moment_factory_w(ce.me, w),
