struct BodnarOkhrinParolyaExpectedReturns{T1 <: AbstractExpectedReturnsEstimator,
...
function w_moment_factory(ce::BodnarOkhrinParolyaExpectedReturns,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return BodnarOkhrinParolyaExpectedReturns(; me = w_moment_factory(ce.me, w),
