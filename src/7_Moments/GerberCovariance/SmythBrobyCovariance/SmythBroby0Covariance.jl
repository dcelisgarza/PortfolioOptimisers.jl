struct SmythBroby0Covariance{T1 <: AbstractExpectedReturnsEstimator,
...
function SmythBroby0Covariance(;
    ...
    return SmythBroby0Covariance{typeof(me), typeof(ve), typeof(pdm), typeof(threshold),
                                 typeof(c1), typeof(c2), typeof(c3), typeof(n)}(me, ve, pdm,
                                                                                threshold,
                                                                                c1, c2, c3,
                                                                                n)
end
function w_moment_factory(ce::SmythBroby0Covariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBroby0Covariance(; me = w_moment_factory(ce.me, w),
