struct SmythBroby2NormalisedCovariance{T1 <: AbstractExpectedReturnsEstimator,
...
function SmythBroby2NormalisedCovariance(;
    ...
    return SmythBroby2NormalisedCovariance{typeof(me), typeof(ve), typeof(pdm),
                                           typeof(threshold), typeof(c1), typeof(c2),
                                           typeof(c3), typeof(n)}(me, ve, pdm, threshold,
                                                                  c1, c2, c3, n)
end
function w_moment_factory(ce::SmythBroby2NormalisedCovariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBroby2NormalisedCovariance(; me = w_moment_factory(ce.me, w),
