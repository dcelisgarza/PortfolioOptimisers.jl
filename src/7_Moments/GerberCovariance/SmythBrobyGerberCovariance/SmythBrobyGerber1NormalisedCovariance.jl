struct SmythBrobyGerber1NormalisedCovariance{T1 <: AbstractExpectedReturnsEstimator,
...
function SmythBrobyGerber1NormalisedCovariance(;
    ...
    return SmythBrobyGerber1NormalisedCovariance{typeof(me), typeof(ve), typeof(pdm),
                                                 typeof(threshold), typeof(c1), typeof(c2),
                                                 typeof(c3), typeof(n)}(me, ve, pdm,
                                                                        threshold, c1, c2,
                                                                        c3, n)
end
function w_moment_factory(ce::SmythBrobyGerber1NormalisedCovariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBrobyGerber1NormalisedCovariance(; me = w_moment_factory(ce.me, w),
