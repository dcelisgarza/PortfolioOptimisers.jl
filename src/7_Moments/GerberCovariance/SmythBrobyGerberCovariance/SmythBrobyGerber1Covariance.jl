struct SmythBrobyGerber1Covariance{T1 <: AbstractExpectedReturnsEstimator,
...
function SmythBrobyGerber1Covariance(;
    ...
    return SmythBrobyGerber1Covariance{typeof(me), typeof(ve), typeof(pdm),
                                       typeof(threshold), typeof(c1), typeof(c2),
                                       typeof(c3), typeof(n)}(me, ve, pdm, threshold, c1,
                                                              c2, c3, n)
end
function w_moment_factory(ce::SmythBrobyGerber1Covariance,
                          w::Union{Nothing, <:AbstractWeights} = nothing)
    return SmythBrobyGerber1Covariance(; me = w_moment_factory(ce.me, w),
