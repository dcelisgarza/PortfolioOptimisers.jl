...
function calc_moment_target(
    ::Union{
        <:LowOrderMoment{<:Any,Nothing,Nothing,<:Any},
...
function calc_moment_target(
    r::Union{
        <:LowOrderMoment{<:Any,<:AbstractWeights,Nothing,<:Any},
...
function calc_moment_target(
    r::Union{
        <:LowOrderMoment{<:Any,<:Any,<:AbstractVector,<:Any},
...
function calc_moment_target(
    r::Union{
        <:LowOrderMoment{<:Any,<:Any,<:Real,<:Any},
        <:HighOrderMoment{<:Any,<:Any,<:Real,<:Any},
    },
    ::Any,
    ::Any,
)
...
function (r::LowOrderMoment{<:Any,<:Any,<:Any,<:FirstLowerMoment})(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
)
...
function (
    r::LowOrderMoment{
        ...
        <:Any,
        <:Any,
        <:LowOrderDeviation{<:Any,<:SecondLowerMoment{<:SqrtRiskExpr}},
    }
)(
    w::AbstractVector,
    X::AbstractMatrix,
...
function (
    r::LowOrderMoment{
        ...
        <:Any,
        <:Any,
        <:LowOrderDeviation{<:Any,<:SecondCentralMoment{<:SqrtRiskExpr}},
    }
)(
    w::AbstractVector,
    X::AbstractMatrix,
...
function (r::LowOrderMoment{<:Any,<:Any,<:Any,<:MeanAbsoluteDeviation})(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
)
...
function (r::HighOrderMoment{<:Any,<:Any,<:Any,<:ThirdLowerMoment})(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
)
...
function (r::HighOrderMoment{<:Any,<:Any,<:Any,<:FourthLowerMoment})(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
)
...
function (r::HighOrderMoment{<:Any,<:Any,<:Any,<:FourthCentralMoment})(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
)
...
function (
    r::HighOrderMoment{<:Any,<:Any,<:Any,<:HighOrderDeviation{<:Any,<:ThirdLowerMoment}}
)(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
...
function (
    r::HighOrderMoment{<:Any,<:Any,<:Any,<:HighOrderDeviation{<:Any,<:FourthLowerMoment}}
)(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
...
function (
    r::HighOrderMoment{<:Any,<:Any,<:Any,<:HighOrderDeviation{<:Any,<:FourthCentralMoment}}
)(
    w::AbstractVector,
    X::AbstractMatrix,
    fees::Union{Nothing,<:Fees} = nothing,
