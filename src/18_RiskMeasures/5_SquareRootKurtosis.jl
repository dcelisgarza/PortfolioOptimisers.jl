...
function calc_moment_target(
    ::SquareRootKurtosis{<:Any,Nothing,Nothing,<:Any,<:Any,<:Any},
    ::Any,
    x::AbstractVector,
)
    return mean(x)
...
function calc_moment_target(
    r::SquareRootKurtosis{<:Any,<:AbstractWeights,Nothing,<:Any,<:Any,<:Any},
    ::Any,
    x::AbstractVector,
)
    return mean(x, r.w)
...
function calc_moment_target(
    r::SquareRootKurtosis{<:Any,<:Any,<:AbstractVector,<:Any,<:Any,<:Any},
    w::AbstractVector,
    ::Any,
)
    return dot(w, r.mu)
...
function calc_moment_target(
    r::SquareRootKurtosis{<:Any,<:Any,<:Real,<:Any,<:Any,<:Any},
    ::Any,
    ::Any,
)
    return r.mu
...
function factory(
    r::SquareRootKurtosis,
    pr::HighOrderPrior{<:LowOrderPrior,<:Any,<:Any,<:Any,<:Any},
    args...;
    kwargs...,
)
