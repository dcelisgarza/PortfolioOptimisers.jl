...
function UncertaintySetVariance(;
    settings::RiskMeasureSettings = RiskMeasureSettings(),
    ucs::Union{Nothing,<:AbstractUncertaintySetResult,<:AbstractUncertaintySetEstimator} = NormalUncertaintySet(;),
...
export QuadRiskExpr,
    SOCRiskExpr, RSOCRiskExpr, Variance, StandardDeviation, UncertaintySetVariance
