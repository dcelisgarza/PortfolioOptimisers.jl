...
[`optimal_number_clusters`](@ref) runs these steps, and both branches run the same ones. The bodies live in `03_Hierarchical.jl` and in `04_NonHierarchicalClustering.jl`.
