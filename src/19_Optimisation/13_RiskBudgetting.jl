...
function _set_risk_budgetting_constraints!(
    model::JuMP.Model,
    rb::RiskBudgetting,
...
function set_risk_budgetting_constraints!(
    model::JuMP.Model,
    rb::RiskBudgetting{<:Any,<:Any,<:AssetRiskBudgetting,<:Any},
    ...
    rkb = _set_risk_budgetting_constraints!(
        model,
        rb,
        model[:w],
        sets;
...
function set_risk_budgetting_constraints!(
    model::JuMP.Model,
    rb::RiskBudgetting{<:Any,<:Any,<:FactorRiskBudgetting,<:Any},
    sets::Union{Nothing,<:AssetSets},
    pr::AbstractPriorResult,
    wb::WeightBounds,
    rd::ReturnsResult,
...
function optimise!(
    ...
    (;
        ...
        fees,
        ret,
    ) = processed_jump_optimiser_attributes(rb.opt, rd; dims = dims)
    model = JuMP.Model()
    ...
    return JuMPOptimisationRiskBudgetting(
        typeof(rb),
