...
const AbstractLowOrderPriorEstimatorMap_2_1 =
    Union{<:AbstractLowOrderPriorEstimator_1_0,<:AbstractLowOrderPriorEstimator_1o2_1o2}
const AbstractLowOrderPriorEstimatorMap_2_2 = Union{
    <:AbstractLowOrderPriorEstimator_2_1,
    <:AbstractLowOrderPriorEstimator_2_2,
    <:AbstractLowOrderPriorEstimator_1o2_1o2,
}
const AbstractLowOrderPriorEstimatorMap_1o2_1o2 = Union{
...
function phylogeny_matrix(
    necle::Union{<:Network,<:ClusteringEstimator},
...
function centrality_vector(
    necte::Union{<:Network,<:Centrality},
