...
#         A_eq = vcat(epc.A_eq, pos_part * ialpha)
#         B_eq = vcat(epc.B_eq, B .- x)
...
function ep_cvar_views_solve!(cvar_views::Union{<:AbstractString, Expr,
                              ...
                              opt::AbstractEntropyPoolingOptimiser; strict::Bool = false)
