...
# Constructor
    ...
    ReturnsResult(nx::Union{Nothing, <:AbstractVector{<:AbstractString}},
                  X::Union{Nothing, <:NumMat},
                  nf::Union{Nothing, <:AbstractVector{<:AbstractString}},
                  F::Union{Nothing, <:NumMat},
                  ts::Union{Nothing, <:AbstractVector{<:Dates.AbstractTime}},
                  iv::Union{Nothing, <:NumMat}, ivpa::Union{Nothing, <:Number, <:NumVec})
