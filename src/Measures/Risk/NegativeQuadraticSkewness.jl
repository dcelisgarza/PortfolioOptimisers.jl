struct NegativeQuadraticSkewness{T1 <: RiskMeasureSettings, T2 <: MatrixProcessing,
...
function NegativeQuadraticSkewness(; settings::RiskMeasureSettings = RiskMeasureSettings(),
    ...
    return NegativeQuadraticSkewness{typeof(settings), typeof(mp), typeof(sk), typeof(V)}(settings,
                                                                                          mp,
                                                                                          sk,
                                                                                          V)
end
function (r::NegativeQuadraticSkewness)(w::AbstractVector)
    return dot(w, r.V, w)
end
function _risk_measure_factory(r::NegativeQuadraticSkewness, prior::HighOrderPriorModel)
...
function risk_measure_factory(r::NegativeQuadraticSkewness; prior::AbstractPriorModel,
                              kwargs...)
    return _risk_measure_factory(r, prior)
end
function cluster_negative_skewness(::NegativeQuadraticSkewness{<:Any, <:Any, Nothing,
                                                               <:Any}, ::Nothing,
...
function cluster_negative_skewness(skew_rm::NegativeQuadraticSkewness{<:Any, <:Any,
                                                                      <:AbstractMatrix,
                                                                      <:Any},
                                   prior::AbstractPriorModel, cluster::AbstractVector)
...
function cluster_risk_measure_factory(r::NegativeQuadraticSkewness;
                                      prior::AbstractPriorModel, cluster::AbstractVector,
                                      kwargs...)
...
export NegativeQuadraticSkewness
