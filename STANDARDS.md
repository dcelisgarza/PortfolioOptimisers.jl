...
| A reference to a GitHub issue, a pull request, an ADR, or an unpublished numerical experiment inside a docstring, including inside an admonition | [`.github/instructions/julia-docstrings.instructions.md`](.github/instructions/julia-docstrings.instructions.md) § *A docstring cites no process* | none — unenforced |
