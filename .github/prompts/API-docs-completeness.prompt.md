...
2. For each symbol with a docstring:
    ...
    - Ensure exported symbols are listed under the "Public" section and non-exported symbols under the "Private" section.
...
3. Report:
    ...
    - Any symbols under the wrong section (public vs private) in the markdown files.
