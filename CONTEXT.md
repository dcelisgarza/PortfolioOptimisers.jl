...
*Avoid*: a member of the online family that reads the whole buffer, which would break the Causal Pass; and a wrapper that makes a walk-forward fit read its test rows, which this library does not ship.
