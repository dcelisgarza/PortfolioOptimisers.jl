...
# rules of `.github/instructions/julia-literate-prose.instructions.md` that a parser can read. The
...
# `.github/instructions/julia-literate-prose.instructions.md` § *The Gate* says why: "the expected
...
`.github/instructions/julia-literate-prose.instructions.md`.
"""
...
function baseline_text(m; root::AbstractString = REPO_ROOT)
    ...
    println(io,
            "# .github/instructions/julia-literate-prose.instructions.md. A count may fall and")
