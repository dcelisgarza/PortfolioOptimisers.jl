...
```@meta
EditURL = "../../../examples/00_Examples.jl"
```
...
For a quick introduction of the package's functionality, see the [User Guide](https://dcelisgarza.github.io/PortfolioOptimisers.jl/stable/user_guide/00_User_Guide).
