...
The first algorithm set: the two benchmark rules, exponentiated gradient, the online Newton step, passive aggressive mean reversion with its three slack rules, and the Expert Mixture whose wealth-weighted form over sampled constant rebalanced portfolios is the universal portfolio.
