```@meta
Description = "Online selection rules: the adaptive subgradient and the optimistic step, public API of PortfolioOptimisers.jl: DiagonalProjection, AdaptiveSubgradient, …"
```
