```@meta
Description = "Geodesic shrinkage covariance, public API of PortfolioOptimisers.jl: GeodesicShrinkageCovariance, IdentityTarget, ScaledIdentityTarget, CommonCovarianceTarget, ConstantCorrelationTarget, cov, …"
```
