```@meta
Description = "Partial fit, private API of PortfolioOptimisers.jl: assert_mergeable_states, chan_merge, assert_partial_fit_state, partial_fit_cache, observation_count."
```
