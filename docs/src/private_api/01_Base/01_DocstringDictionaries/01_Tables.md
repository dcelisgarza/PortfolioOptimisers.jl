...
This file declares the seven tables and the guard that fills them. Each later file of `src/01_Base/01_DocstringDictionaries/` fills one table for one subject, and its page names the table and the subject.
