...
| 0071 | [A dismissed JET report is keyed by file, kind and message](0071-a-dismissed-jet-report-is-keyed-by-file-kind-and-message.md) | | A Report Fingerprint is the attribution file, the report kind and the message. No line, no stack trace, no signature render. A Dismissal covers the class and cites a shared Rationale, and so does an Exemption; re-affirmation on a Julia bump binds the JET side alone. |
