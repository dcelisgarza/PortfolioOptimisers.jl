...
@testset "Interfaces census: every `# Interfaces` section names methods and types that exist" begin
    ...
    debt = Set([:AbstractAlgorithm, :AbstractAssetPanelEstimator, :AbstractAssetSelector,
                ...
                :AbstractOrderedWeightsArrayEstimator, :AbstractOrthogonalityMetric,
                :AbstractParsingResult, :AbstractPhylogenyConstraintEstimator,
                :AbstractPhylogenyConstraintResult, :AbstractPhylogenyFeatureAlgorithm,
                :AbstractPhylogenyResult, :AbstractPipelineEstimator,
                :AbstractPipelineResult, :AbstractPredictionResult,
                :AbstractPreprocessingEstimator, :AbstractPricesPreprocessingEstimator,
                :AbstractPricesPreprocessingResult, :AbstractPricesResult,
