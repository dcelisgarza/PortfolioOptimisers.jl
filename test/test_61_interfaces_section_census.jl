...
@testset "Interfaces census: every `# Interfaces` section names methods and types that exist" begin
    ...
    debt = Set([:AbstractAlgorithm, :AbstractAssetPanelEstimator, :AbstractAssetSelector,
                :AbstractCalibrationSeries, :AbstractCentralityAlgorithm,
                :AbstractCentralityConstraint, :AbstractCentralityEstimator,
                :AbstractCentralityPolarity, :AbstractClusteringResult,
                :AbstractClustersEstimator, :AbstractCollapseAlgorithm,
                ...
                :AbstractHighOrderPriorEstimator_F, :AbstractJuMPResult,
                :AbstractLoadingsRegressionResult, :AbstractLowOrderPriorEstimator_A,
                :AbstractLowOrderPriorEstimator_AF, :AbstractLowOrderPriorEstimator_F,
                ...
                :AbstractOrderedWeightsArrayEstimator, :AbstractOrthogonalScaling,
                :AbstractOrthogonalityMetric, :AbstractParsingResult,
                ...
                :AbstractPredictionResult, :AbstractPreprocessingEstimator,
                :AbstractPricesPreprocessingEstimator, :AbstractPricesPreprocessingResult,
                :AbstractPricesResult, :AbstractRegressionTarget,
                :AbstractRegularisationEstimator,
                :AbstractRelativisticValueatRiskViewFormulation, :AbstractResult,
                :AbstractReturnForecastResult, :AbstractReturnsPreprocessingResult,
                :AbstractReturnsResult, :AbstractRiskSeriesAlgorithm,
                ...
                :HierarchicalRiskMeasure, :HierarchicalScalariser,
                :HighOrderMomentMeasureAlgorithm, :HopCountAlgorithm,
                :InverseMatrixSparsificationAlgorithm, :JuMPOptimisationEstimator,
                :JuMPReturnsEstimator, :JuMPRiskMeasureSettings,
                ...
                :RiskJuMPOptimisationResult, :RiskMeasure, :SchurComplementAlgorithm,
