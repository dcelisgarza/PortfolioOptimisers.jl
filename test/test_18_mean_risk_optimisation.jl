@safetestset "Mean Risk Optimisation" begin
    ...
    @testset "Regularisation" begin
        ...
        res = optimise(mr)
        @test isapprox(res.w,
                       [-0.09035661903550253, -0.03351161350315835, -0.027370584644720097,
                        -0.03115192778736241, 0.10200878675171382, 0.04907851675886963,
                        0.044965635639615545, 0.19490547888547421, 0.06950763050603664,
                        0.12254741320549994, -0.01278089926732436, 0.16617083950051534,
                        0.059801136376555236, 0.1269446577304391, 0.0024655987959523794,
                        0.09321699380968822, -0.023531714164422162, 0.01750764663615544,
                        0.10499413435031364, 0.0645888847489714], rtol = 1e-6)
    ...
    @testset "Phylogeny" begin
        ...
        @test (isapprox(res.w,
                        [-5.83349251195602e-14, -0.7549102373927532, -0.24489685036355585,
                         2.5425310153855233e-16, 1.177641184405827e-13,
                         -1.1761565067160182e-14, -3.8671847486726096e-14,
                         1.2944646679137976e-14, -1.9475087209248426e-14,
                         0.26951016407394074, 8.367112463199218e-14, 0.7303004971078252,
                         -6.194837681595708e-14, 2.309812136692163e-14,
                         -2.5460214715889667e-14, -8.58412864279287e-15,
                         1.1757019029014802e-13, 2.1546906367143115e-14,
                         5.7299916350654655e-15, 0.9999964265744166]; rtol = 1e-6) ||
               isapprox(res.w,
                        [-4.400162786139801e-14, -0.7068647775696704, -0.20178701626483694,
                         -1.0233912058364145e-15, 8.336251924927799e-14,
                         -1.0638713372805883e-14, -0.09129358185248605,
                         4.326412562038434e-15, -1.626576456755123e-14, 0.2751905375771391,
                         5.428666085696465e-14, 0.7247587488302388, -4.6429454132911124e-14,
                         1.1792066087999556e-14, -2.2237835848208057e-14,
                         -1.100539171494297e-14, 8.51166817026479e-14,
        ...
        @test isapprox(res1.w,
                       [-8.941947065896066e-10, -0.04932710440381371,
                        -6.863938562738464e-10, 1.3988410703687132e-9, 7.874062368849783e-9,
                        1.412585165547874e-10, 1.7321574723075382e-11, 3.14807397478865e-9,
                        2.533850859517078e-10, 4.2259407336717684e-9, 9.27519848836695e-9,
                        0.5762987006529464, -8.9766618039303e-10, 3.2999661080490746e-9,
                        1.890273506358333e-9, 2.284039630442464e-9, 4.098035458673607e-9,
                        2.8259584736181038e-9, 1.9502905591238874e-9, 0.4730283635464767],
                       rtol = 1e-6)
        ...
        @test isapprox(res2.w,
                       [4.538887108402e-12, -6.1572184586398375e-12, 5.890457303938837e-12,
                        1.1064891957189628e-11, 8.16860330669961e-11,
                        1.0447686807968064e-11, 7.515312850909054e-12,
                        3.4302092558703144e-11, 9.830689623680973e-12,
                        4.196444332597126e-11, 1.595363611128629e-10, 0.44103049364497793,
                        4.015117234808678e-12, 3.734698654521197e-11,
                        1.9818372625965523e-11, 2.3540415362795815e-11,
                        6.674140406117119e-11, 3.620870179464855e-11,
        ...
        @test isapprox(res1.w,
                       [5.795063775028467e-10, 1.6700229186291166e-11,
                        1.3737504141980956e-9, 7.553971775400608e-10, 0.15491240378613524,
                        8.130769655580166e-10, 0.052786428307945235, 0.3010004052356739,
                        0.12864415218245234, 1.6194212944642728e-9, 1.7330018300923791e-9,
                        0.3044224075653002, 1.6587453277888904e-9, 1.1846793161814234e-9,
                        6.789585538788945e-10, 1.2549206102211462e-9, 5.816904347357348e-10,
                        9.192974758044433e-10, 1.3752920313726993e-9, 0.05823418837805521],
                       rtol = 1e-6)
        ...
        @test isapprox(res2.w,
                       [9.734211379642436e-10, 4.1083003213516983e-10,
                        1.8417217137810698e-9, 1.1175942079694052e-9, 0.22174568685948925,
                        1.1252994093191541e-9, 0.10878815061030933, 0.22584558658264856,
                        0.16804999751018831, 1.3691721404910584e-9, 1.8115167652939963e-9,
                        0.2755704634873393, 2.712875597891968e-9, 1.264257843844942e-9,
                        6.749859978725407e-10, 1.2598949048283668e-9, 8.634272415613415e-10,
                        7.875561180262464e-10, 1.7964324466334559e-9, 9.69410371286415e-8],
                       rtol = 1e-6)
    end
    ...
    @testset "Fees" begin
        ...
        @test isapprox(res.w,
                       [-0.049849956175178456, 0.05299448616838142, -0.22771293882094312,
                        ...
                        -0.0, 0.35475349716097293, 0.2908544599359326, 0.05579460357877945,
