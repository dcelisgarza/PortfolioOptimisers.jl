...
using PortfolioOptimisers, Test, DataFrames, TimeSeries, CSV
...
Fees(; l = 0.001, s = 0.002, fl = 0.005, fs = 0.007, tn = Turnover(; val = 0.011, w = w))
...
fes = [Fees(; l = 0.01, s = 0.02, fl = 0.05, fs = 0.07,
       ...
       Fees(; l = lw, s = sw, fl = flw, fs = slw, tn = Turnover(; val = tv, w = w2)),
       Fees(;), Fees(;), Fees(;)]
