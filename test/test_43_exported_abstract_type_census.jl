@testset "Exported abstract type census: the export list is an allow-list" begin
    ...
    allowed_public = Set([:ARCHBootstrapSet, :AbstractAmbiguityRadiusCalibrationAlgorithm,
                          ...
                          :AbstractUncertaintyKAlgorithm, :AbstractUncertaintySetAlgorithm,
                          :AbstractUncertaintySetClass, :AbstractUncertaintySetEstimator,
                          :AbstractUncertaintySetResult, :AbstractVarianceEstimator,
                          :BaseGerberCovariance, :BaseGerberIQCovariance, :BinWidthBins,
