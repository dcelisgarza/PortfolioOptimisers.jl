...
@testset "Black Litterman Prior" begin
    ...
    vc_2 = LinearConstraintAtom(; group = [:Asset, :Asset], name = [3, 8], coef = [1, -1],
                                cnst = -0.001)
    ...
    @test_throws TypeError views_constraints(LinearConstraintAtom(; group = :Foo, name = 2,
                                                                  coef = 1, cnst = 0.003),
                                             sets)
...
@testset "Bayesian Black Litterman Prior" begin
    ...
    vc_2 = LinearConstraintAtom(; group = [:Factor, :Factor], name = [4, 1], coef = [1, -1],
                                cnst = -0.001)
    vc_3 = LinearConstraintAtom(; group = [:Factor, :Factor], name = [2, 3], coef = [1, -1],
                                cnst = 0.002)
