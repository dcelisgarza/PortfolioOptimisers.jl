@safetestset "Moments" begin
    ...
    @testset "Expected Returns" begin
        ...
        mes = [SimpleExpectedReturns(), SimpleExpectedReturns(; w = ew),
               ...
               JamesSteinExpectedReturns(; w = ew),
               JamesSteinExpectedReturns(; w = ew, target = SERT_VolatilityWeighted()),
               JamesSteinExpectedReturns(; w = ew, target = SERT_MeanSquareError()),
               ...
               BayesSteinExpectedReturns(; w = ew),
               BayesSteinExpectedReturns(; w = ew, target = SERT_VolatilityWeighted()),
               BayesSteinExpectedReturns(; w = ew, target = SERT_MeanSquareError()),
               ...
               BodnarOkhrinParolyaExpectedReturns(; w = ew),
               BodnarOkhrinParolyaExpectedReturns(; w = ew,
