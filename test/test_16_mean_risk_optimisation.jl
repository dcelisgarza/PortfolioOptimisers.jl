@safetestset "Mean Risk Optimisation" begin
    ...
    @testset "Phylogeny" begin
        ...
        @test isapprox(res.w,
                       if Sys.isapple()
                           [-5.83349251195602e-14, -0.7549102373927532,
                            -0.24489685036355585, 2.5425310153855233e-16,
                            1.177641184405827e-13, -1.1761565067160182e-14,
                            -3.8671847486726096e-14, 1.2944646679137976e-14,
                            -1.9475087209248426e-14, 0.26951016407394074,
                            8.367112463199218e-14, 0.7303004971078252,
                            ...
                            5.7299916350654655e-15, 0.9999964265744166]
                       else
                           [-4.400162786139801e-14, -0.7068647775696704,
                            -0.20178701626483694, -1.0233912058364145e-15,
                            8.336251924927799e-14, -1.0638713372805883e-14,
                            -0.09129358185248605, 4.326412562038434e-15,
                            -1.626576456755123e-14, 0.2751905375771391,
                            5.428666085696465e-14, 0.7247587488302388,
                            -4.6429454132911124e-14, 1.1792066087999556e-14,
                            -2.2237835848208057e-14, -1.100539171494297e-14,
                            8.51166817026479e-14, 1.0879558335436499e-14,
                            8.09956925306327e-16, 0.9999960892795525]
                       end, rtol = 1e-6)
